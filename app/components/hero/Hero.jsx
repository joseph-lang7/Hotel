...
const Hero = () => {
  return (
    <div
      className="w-screen h-[1200px] md:h-[800px] bg-cover bg-center flex items-center relative"
    ...
    >
      ...
      <div className="w-full flex justify-center px-5 h-auto  absolute bottom-0">
        <div className="bg-black w-[1500px] grid grid-cols-1 md:grid-cols-2  xl:grid-cols-4 gap-5">
